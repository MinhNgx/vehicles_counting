...
START_POINT = 80 #Line 1
END_POINT = 150 #Line 2
CLASSES = ["person", "bicycle", "car", "motorbike", "aeroplane", "bus", "train", "truck",
           ...
           "book", "clock", "vase", "scissors", "teddy bear", "hair drier", "toothbrush"] #80 class yolov3
# Define vehicle class
VEHICLE_CLASSES = [1, 2, 3, 5, 6, 7] #class vehicle

# get it at https://pjreddie.com/darknet/yolo/
YOLOV3_CFG = r'D:\Python Tutorial\couting_car\vehicles_counting\yolov3-tiny.cfg.txt'
YOLOV3_WEIGHT = r'D:\Python Tutorial\couting_car\vehicles_counting\yolov3-tiny.weights'
...
if __name__ == '__main__':
    counting_vehicle(r'D:\Python Tutorial\couting_car\vehicles_counting\highway.mp4', r'D:\Python Tutorial\couting_car\vehicles_counting\vehicles.avi')
